...
/***/ function(module, exports, __webpack_require__) {
	...
	var jasmineReact = __webpack_require__(178);
	var Survey = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var CheckboxWithLabel = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jasmineReact = {
	  render: function render(component, container, callback) {
	    if (typeof container === "undefined") {
	      container = this.getDefaultContainer();
	    }

	    var comp = typeof callback === "undefined" ? React.render(component, container) : React.render(component, container, callback);
	  ...
	  spyOnClass: function spyOnClass(klass, methodName) {
	  ...
	  classComponentConstructor: function classComponentConstructor(klass) {
	    return klass.type || // React 0.11.1
	    klass.componentConstructor; // React 0.8.0
	  },

	  classPrototype: function classPrototype(klass) {
	  ...
	  createStubComponent: function createStubComponent(obj, propertyName) {
	  ...
	  addMethodToClass: function addMethodToClass(klass, methodName, methodDefinition) {
	  ...
	  resetComponentStubs: function resetComponentStubs() {
	  ...
	  removeAllSpies: function removeAllSpies() {
	  ...
	  unmountAllRenderedComponents: function unmountAllRenderedComponents() {
	  ...
	  unmountComponent: function unmountComponent(component) {
